package com.follower.maze.users.accept;
...
public class AcceptUserProcessor implements Processor {
    private final ConcurrentHashMap<Integer, User> users;
    private final AtomicBoolean continueRunning;

    public AcceptUserProcessor(ConcurrentHashMap<Integer, User> users, AtomicBoolean continueRunning) {
        this.users = users;
